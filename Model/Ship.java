...
public class Ship extends Vehicle {
    // public Ship(String vehicleID, String name, double currentFuel, double
    // carryingCapacity, double fuelCapacity, Port currentPort, int totalContainers,
    // ArrayList<Container> containers, Map<Container.ContainerType, Integer>
    // containerCounts) {
    // super(vehicleID, name, currentFuel, carryingCapacity, fuelCapacity,
    // currentPort, totalContainers, containers, containerCounts);
