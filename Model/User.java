...
public abstract class User {
    ...
    // for (Trip trip : trips) {
    // if ((date.after(trip.getDepartureDate()) &&
    // date.before(trip.getArrivalDate()))
    // || (date.equals(trip.getDepartureDate())) ||
    // (date.equals(trip.getArrivalDate()))) {
    // Vehicle vehicle = trip.getVehicle();
    // ArrayList<Container> containers = trip.getContainersOnTrip();
    // // Get the distance traveled during the trip
    // double distance =
    // trip.getDeparturePort().calculateDistance(trip.getArrivalPort());
    //
    ...
    // long tripDurationInDays = (trip.getDepartureDate().getTime() -
    // trip.getArrivalDate().getTime())
    // / millisecondsInADay;
    // // Calculate daily fuel consumption for this trip
    // dailyFuelUsage *= distance / tripDurationInDays;
    // }
    // }
    // System.out.println("Total fuel used on " + date + " is: " + dailyFuelUsage +
    // " gallons");
    // }
